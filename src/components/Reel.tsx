...
export default function Reel({ projects, activeSlug }: { projects: Project[]; activeSlug?: string }) {
  return (
    <nav className="flex flex-col min-h-0 border-r border-line bg-gradient-to-b from-grain to-ink" aria-label="Project reel">
